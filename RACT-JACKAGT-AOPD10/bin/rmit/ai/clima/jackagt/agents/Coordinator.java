...
import rmit.ai.clima.jackagt.plans.PCoord_HandleCellInfoRequest;
import rmit.ai.clima.jackagt.plans.PCoord_AssimilatePlayerStates;
...
import rmit.ai.clima.jackagt.plans.PIdentifyExploreTarget;
...
import rmit.ai.clima.jackagt.capabilities.CResolvePlayerActions;
...
public class Coordinator extends aos.jack.jak.agent.Agent implements rmit.ai.clima.interfaces.DebugInterface {
    ...
    public rmit.ai.clima.jackagt.capabilities.CResolvePlayerActions cresolveplayeractions_cap;
    private rmit.ai.clima.jackagt.events.MEReturnPathfinding mereturnpathfinding_s;
    private rmit.ai.clima.jackagt.events.MEReturnPlayerState mereturnplayerstate_s;
    private rmit.ai.clima.jackagt.events.EFindPath efindpath_p;
    private rmit.ai.clima.jackagt.events.EPostPlayerAction epostplayeraction_p;
    private rmit.ai.clima.jackagt.events.EFindClosestGold efindclosestgold_p;
    private rmit.ai.clima.jackagt.events.EIdentifyTarget eidentifytarget_p;
    ...
    private rmit.ai.clima.jackagt.events.MEPlayerAction meplayeraction_p;
    private rmit.ai.clima.jackagt.events.MEReturnCellInfo mereturncellinfo_s;
    private rmit.ai.clima.jackagt.events.MEPlayerPerceptsAssimilated meplayerperceptsassimilated_s;
...
/* Constructor */
    ...
    public void __init1()
    {
        ...
        setNamedCreator("bel_playerStateReceived_dat","rmit.ai.clima.jackagt.data.BPlayer",new aos.jack.jak.agent.DataCreator(true){
            public java.lang.Object create()
            {
                return __named_data_bel_playerStateReceived_dat();
            }
        ...
        setNamedCreator("bel_playerState_dat","rmit.ai.clima.jackagt.data.BPlayerState",new aos.jack.jak.agent.DataCreator(true){
            public java.lang.Object create()
            {
                return __named_data_bel_playerState_dat();
            }
        ...
        if (cresolveplayeractions_cap == null) {
            cresolveplayeractions_cap = new rmit.ai.clima.jackagt.capabilities.CResolvePlayerActions(this);
            cresolveplayeractions_cap.__initCapability(this,"cresolveplayeractions_cap");
        }
        cresolveplayeractions_cap.__init1();
    }
    ...
    public void __init2()
    {
        ...
        getNamedObject("bel_playerStateReceived_dat","rmit.ai.clima.jackagt.data.BPlayer");
        ...
        getNamedObject("bel_playerState_dat","rmit.ai.clima.jackagt.data.BPlayerState");
        ...
        mereturnpathfinding_s = (rmit.ai.clima.jackagt.events.MEReturnPathfinding) findEvent("rmit.ai.clima.jackagt.events.MEReturnPathfinding");
        mereturnplayerstate_s = (rmit.ai.clima.jackagt.events.MEReturnPlayerState) findEvent("rmit.ai.clima.jackagt.events.MEReturnPlayerState");
        efindpath_p = (rmit.ai.clima.jackagt.events.EFindPath) findEvent("rmit.ai.clima.jackagt.events.EFindPath");
        epostplayeraction_p = (rmit.ai.clima.jackagt.events.EPostPlayerAction) findEvent("rmit.ai.clima.jackagt.events.EPostPlayerAction");
        efindclosestgold_p = (rmit.ai.clima.jackagt.events.EFindClosestGold) findEvent("rmit.ai.clima.jackagt.events.EFindClosestGold");
        eidentifytarget_p = (rmit.ai.clima.jackagt.events.EIdentifyTarget) findEvent("rmit.ai.clima.jackagt.events.EIdentifyTarget");
        ...
        meplayeraction_p = (rmit.ai.clima.jackagt.events.MEPlayerAction) findEvent("rmit.ai.clima.jackagt.events.MEPlayerAction");
        mereturncellinfo_s = (rmit.ai.clima.jackagt.events.MEReturnCellInfo) findEvent("rmit.ai.clima.jackagt.events.MEReturnCellInfo");
        meplayerperceptsassimilated_s = (rmit.ai.clima.jackagt.events.MEPlayerPerceptsAssimilated) findEvent("rmit.ai.clima.jackagt.events.MEPlayerPerceptsAssimilated");
        cpathfinding_cap.__init2();
        cresolveplayeractions_cap.__init2();
    }
    ...
    synchronized private void __init_desc()
    {
        ...
        addNamedObject("bel_playerStateReceived_dat","rmit.ai.clima.jackagt.data.BPlayer",aos.jack.jak.agent.Agent.WRITEABLE);
        ...
        addNamedObject("bel_playerState_dat","rmit.ai.clima.jackagt.data.BPlayerState",aos.jack.jak.agent.Agent.WRITEABLE);
        ...
        cresolveplayeractions_cap = new rmit.ai.clima.jackagt.capabilities.CResolvePlayerActions(this);
        cresolveplayeractions_cap.__initCapability(this,"cresolveplayeractions_cap");
        cresolveplayeractions_cap.init_desc();
        addEvent("rmit.ai.clima.jackagt.events.MEReturnPathfinding",aos.jack.jak.agent.Agent.SENT_EVENT);
        addEvent("rmit.ai.clima.jackagt.events.MERequestCellInfo",aos.jack.jak.agent.Agent.HANDLED_EVENT);
        addEvent("rmit.ai.clima.jackagt.events.MEReturnPlayerState",aos.jack.jak.agent.Agent.SENT_EVENT);
        addEvent("rmit.ai.clima.jackagt.events.MEReportPlayerState",aos.jack.jak.agent.Agent.HANDLED_EVENT);
        addEvent("rmit.ai.clima.jackagt.events.MERequestPathfinding",aos.jack.jak.agent.Agent.HANDLED_EVENT);
        ...
        addEvent("rmit.ai.clima.jackagt.events.EPostPlayerAction",aos.jack.jak.agent.Agent.HANDLED_EVENT);
        addEvent("rmit.ai.clima.jackagt.events.EPostPlayerAction",aos.jack.jak.agent.Agent.POSTED_EVENT);
        ...
        addEvent("rmit.ai.clima.jackagt.events.EIdentifyTarget",aos.jack.jak.agent.Agent.HANDLED_EVENT);
        addEvent("rmit.ai.clima.jackagt.events.EIdentifyTarget",aos.jack.jak.agent.Agent.POSTED_EVENT);
        ...
        addEvent("rmit.ai.clima.jackagt.events.MEPlayerAction",aos.jack.jak.agent.Agent.POSTED_EVENT);
        addEvent("rmit.ai.clima.jackagt.events.MEReportPlayerPercept",aos.jack.jak.agent.Agent.HANDLED_EVENT);
        addEvent("rmit.ai.clima.jackagt.events.MEReturnCellInfo",aos.jack.jak.agent.Agent.SENT_EVENT);
        addEvent("rmit.ai.clima.jackagt.events.MEPlayerPerceptsAssimilated",aos.jack.jak.agent.Agent.SENT_EVENT);
        addPlan("rmit.ai.clima.jackagt.plans.PCoord_HandleCellInfoRequest",0);
        addPlan("rmit.ai.clima.jackagt.plans.PCoord_AssimilatePlayerStates",0);
        ...
        addPlan("rmit.ai.clima.jackagt.plans.PIdentifyExploreTarget",0);
    ...
    synchronized public void __bindNames()
    {
        ...
        cresolveplayeractions_cap.__bindNames();
    }
    ...
    private rmit.ai.clima.jackagt.data.BPlayer __named_data_bel_playerStateReceived_dat()
    {
        if (bel_playerStateReceived_dat != null) 
            return bel_playerStateReceived_dat;
        bel_playerStateReceived_dat = new rmit.ai.clima.jackagt.data.BPlayer();
        if (!bel_playerStateReceived_dat.attach(this)) 
            bel_playerStateReceived_dat = null;
        setNamedObject("bel_playerStateReceived_dat","rmit.ai.clima.jackagt.data.BPlayer",bel_playerStateReceived_dat);
        return bel_playerStateReceived_dat;
    }
    ...
    private rmit.ai.clima.jackagt.data.BPlayerState __named_data_bel_playerState_dat()
    {
        if (bel_playerState_dat != null) 
            return bel_playerState_dat;
        bel_playerState_dat = new rmit.ai.clima.jackagt.data.BPlayerState();
        if (!bel_playerState_dat.attach(this)) 
            bel_playerState_dat = null;
        setNamedObject("bel_playerState_dat","rmit.ai.clima.jackagt.data.BPlayerState",bel_playerState_dat);
        return bel_playerState_dat;
    }
    ...
    public void setEnabled(boolean t)
    {
        ...
        cresolveplayeractions_cap.setEnabled(t);
    }
