...
public class Coord_ReportAgentInformation extends aos.jack.jak.plan.Plan {
    ...
    private static java.lang.String[] __tt__body = {
            "rmit/ai/clima/jackagt/plans/Coord_ReportAgentInformation.plan",
            "body",
            "33",
            "31"};
    ...
    private final static java.lang.String[] __reasoningMethods = {
            "body"};
    public Coord_ReportAgentInformation()
    {
    }
    
    private Coord_ReportAgentInformation(aos.jack.jak.task.Task __t, rmit.ai.clima.jackagt.plans.Coord_ReportAgentInformation __env)
    {
    ...
    {
        return new rmit.ai.clima.jackagt.plans.Coord_ReportAgentInformation.__bodyFSM();
    }
    
    private Coord_ReportAgentInformation(rmit.ai.clima.jackagt.events.MEInformAgentStatus __ev, aos.jack.jak.task.Task __t, rmit.ai.clima.jackagt.plans.Coord_ReportAgentInformation __env)
    {
        this(__t,__env);
    ...
    public aos.jack.jak.plan.Plan createPlan(aos.jack.jak.event.Event __e, aos.jack.jak.task.Task __t)
    {
        ...
        return new rmit.ai.clima.jackagt.plans.Coord_ReportAgentInformation(__e1,__t,this);
    }
    ...
    class __bodyFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
            ...
            do {
                try {
                    ...
                    if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_PLANS) != 0) 
                        aos.util.logging.LogMsg.log(this,aos.jack.jak.core.Jak.LOG_PLANS,__task + "-Coord_ReportAgentInformation.body:" + java.lang.Integer.toString(__state));
                    if (__task.nsteps > 0) {
                        __task.nsteps-- ;
                        if (__task.nsteps == 0) 
                            agent.changeFocus();
                    ...
                    if (__state < 10) {
                        __status = super.stdrun(rmit.ai.clima.jackagt.plans.Coord_ReportAgentInformation.this,__status);
                    ...
                    switch (__state) {
                        default: 
                        {
                            aos.jack.jak.core.Jak.error("Coord_ReportAgentInformation.body: Illegal state");
                            return FAILED_STATE;
                        }
                        //* (33) 		bel_agentPositions_dat.add(meinformagentstatus_h.agentName,meinformagentstatus_h.agentLocation.x,meinformagentstatus_h.agentLocation.y);
                        case 10: 
                        {
                            __breakLevel = 0;
                            __state = 11;
        ...
        {
            return rmit.ai.clima.jackagt.plans.Coord_ReportAgentInformation.this;
        }
        ...
        public void enter()
        {
            __trace = agent.trace("rmit.ai.clima.jackagt.plans.Coord_ReportAgentInformation.body");
        }
