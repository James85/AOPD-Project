            ...
            do {
                try {
                    ...
                    switch (__state) {
                        ...
                        //* (49)       if (bel_moveHint_dat.getByEndPoints($playerX.as_int(), $playerY.as_int(), $goldX.as_int(), $goldY.as_int(), $move ))
                        case 12: 
                        {
                            boolean __b;
                        ...
                        //* (53)          @send( baseName, meplayeraction_s.send( "moveTo", $move.as_string() ));
                        case 15: 
                        {
                            __state = 16;
