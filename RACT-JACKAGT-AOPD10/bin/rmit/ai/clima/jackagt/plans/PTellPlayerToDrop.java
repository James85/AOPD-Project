...
public class PTellPlayerToDrop extends aos.jack.jak.plan.Plan {
    ...
    {
        return aos.jack.jak.plan.PlanInstanceInfo.def[9];
    }
    
    public PTellPlayerToDrop()
    {
    }
    
    private PTellPlayerToDrop(aos.jack.jak.task.Task __t, rmit.ai.clima.jackagt.plans.PTellPlayerToDrop __env)
    {
        ...
        throws java.lang.Exception
    {
        switch (__index) {
            ...
            case 3: 
            {
                return (new aos.jack.jak.cursor.BinaryBoolOp(this,__logic,aos.jack.jak.cursor.BinaryBoolOp.AND,(short) 2,true,(short) 0,false));
            }
            case 4: 
            {
                return (new aos.jack.jak.cursor.BinaryBoolOp(this,__logic,aos.jack.jak.cursor.BinaryBoolOp.AND,(short) 3,true,(short) 1,false));
            }
            case 5: 
            {
            ...
            case 6: 
            {
                return (new aos.jack.jak.cursor.BinaryBoolOp(this,__logic,aos.jack.jak.cursor.BinaryBoolOp.AND,(short) 4,true,(short) 5,true));
            }
            case 7: 
            {
                return (new aos.jack.jak.cursor.BinaryBoolOp(this,__logic,aos.jack.jak.cursor.BinaryBoolOp.AND,(short) 6,true,(short) 2,false));
            }
        }
        ...
        throws java.lang.Exception
    {
        switch (__index) {
            case 0: 
            {
                return ($playerX.as_int() == $depotX.as_int());
            }
            case 1: 
            {
                return ($playerY.as_int() == $depotY.as_int());
            }
            case 2: 
            {
                return ($numGold.as_int() > 0);
            }
        }
    ...
    {
        return new rmit.ai.clima.jackagt.plans.PTellPlayerToDrop.__bodyFSM();
    }
    
    private PTellPlayerToDrop(rmit.ai.clima.jackagt.events.EPostPlayerAction __ev, aos.jack.jak.task.Task __t, rmit.ai.clima.jackagt.plans.PTellPlayerToDrop __env)
    {
        this(__t,__env);
    ...
    public aos.jack.jak.plan.Plan createPlan(aos.jack.jak.event.Event __e, aos.jack.jak.task.Task __t)
    {
        ...
        return new rmit.ai.clima.jackagt.plans.PTellPlayerToDrop(__e1,__t,this);
    }
    ...
    class __bodyFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
        java.lang.String __local__28_0;
        aos.jack.jak.logic.IntegerVariable __local__28_1;
        aos.jack.jak.logic.IntegerVariable __local__28_2;
            ...
            do {
                try {
                    ...
                    if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_PLANS) != 0) 
                        aos.util.logging.LogMsg.log(this,aos.jack.jak.core.Jak.LOG_PLANS,__task + "-PTellPlayerToDrop.body:" + java.lang.Integer.toString(__state));
                    if (__task.nsteps > 0) {
                        __task.nsteps-- ;
                        if (__task.nsteps == 0) 
                            agent.changeFocus();
                    ...
                    if (__state < 10) {
                        __status = super.stdrun(rmit.ai.clima.jackagt.plans.PTellPlayerToDrop.this,__status);
            ...
            throws java.lang.Exception
        {
            switch (__index) {
                case 0: 
                {
                    return (bel_playerTarget_dat.getByName(epostplayeraction_h.playerName,__local__28_1,__local__28_2));
                }
            }
            aos.jack.jak.core.Jak.error("illegal Cursor Construction");
            return null;
        ...
        {
            return rmit.ai.clima.jackagt.plans.PTellPlayerToDrop.this;
        }
        ...
        public void enter()
        {
            __trace = agent.trace("rmit.ai.clima.jackagt.plans.PTellPlayerToDrop.body");
        }
