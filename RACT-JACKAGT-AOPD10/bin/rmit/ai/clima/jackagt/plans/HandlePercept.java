...
public class HandlePercept extends aos.jack.jak.plan.Plan {
    ...
    class __bodyFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
        rmit.ai.clima.comms.RequestAction __local__17_0;
        int __local__17_1;
        int __local__17_2;
        int __local__17_3;
        int __local__17_4;
        int __local__17_5;
        rmit.ai.clima.gui.grid.GridPoint __local__17_6;
        rmit.ai.clima.comms.Cell[] __local__17_7;
            ...
            do {
                try {
                    ...
                    switch (__state) {
                        ...
                        {
                            __breakLevel = 0;
                            __local__17_0 = (rmit.ai.clima.comms.RequestAction) perceiveclimaserver_h.data;
                            __state = 11;
                            break;
                        }
                        ...
                        case 11: 
                        {
                            __local__17_1 = java.lang.Integer.parseInt(__local__17_0.id.trim());
                            __state = 12;
                            break;
                        }
                        ...
                        case 12: 
                        {
                            __local__17_2 = __local__17_0.step;
                            __state = 13;
                            break;
                        }
                        ...
                        case 13: 
                        {
                            __local__17_3 = __local__17_0.items;
                            __state = 14;
                            break;
                        }
                        ...
                        case 14: 
                        {
                            __local__17_4 = __local__17_0.posx;
                            __state = 15;
                            break;
                        }
                        ...
                        case 15: 
                        {
                            __local__17_5 = __local__17_0.posy;
                            __state = 16;
                            break;
                        }
                        ...
                        case 16: 
                        {
                            __local__17_6 = new rmit.ai.clima.gui.grid.GridPoint(__local__17_4,__local__17_5);
                            __state = 17;
                            break;
                        }
                        ...
                        case 17: 
                        {
                            __local__17_7 = __local__17_0.cells;
                            __state = 18;
                            break;
                        }
                        ...
                        //* (102) 		if(bel_currentPosition_dat.get($locationX,$locationY) && ($locationX.as_int() != posX || $locationY.as_int() != posY))
                        case 19: 
                        {
                            boolean __b;
                        ...
                        //* (104) 			bel_currentPosition_dat.remove($locationX.as_int(),$locationY.as_int());
                        case 20: 
                        {
                            __breakLevel = 2;
                            __state = 21;
                            bel_currentPosition_dat.remove(__local__17_8.as_int(),__local__17_9.as_int());
                            break;
                        }
                        //* (105) 			bel_currentPosition_dat.add(posX,posY);
                        case 21: 
                        {
                            __state = 22;
                            bel_currentPosition_dat.add(__local__17_4,__local__17_5);
                            break;
                        }
                        //* (109) 		logical int $noGold;
                        case 22: 
                        {
                        ...
                        //* (110) 		bel_numCarryingGold_dat.getCarryingGold($noGold);
                        case 23: 
                        {
                            boolean __b;
                            aos.jack.jak.cursor.Cursor __c = null;
                        ...
                        //* (111) 		if($noGold.as_int() != items)
                        case 24: 
                        {
                            if (__local__17_10.as_int() != __local__17_3) 
                                __state = 25;
                             else 
                                __state = 27;
                            break;
                        }
                        //* (113) 			bel_numCarryingGold_dat.remove($noGold.as_int());
                        case 25: 
                        {
                            __breakLevel = 2;
                            __state = 26;
                            bel_numCarryingGold_dat.remove(__local__17_10.as_int());
                            break;
                        }
                        ...
                        {
                            __state = 27;
                            bel_numCarryingGold_dat.add(__local__17_3);
                            break;
                        }
                        //* (121) 		@subtask( eupdatebel_s.post(id, currentPos, cells, items) );
                        case 27: 
                        {
                            __task.push(eupdatebel_s.post(__local__17_1,__local__17_6,__local__17_7,__local__17_3));
                            __state = -__state;
                            __subtask_pass = 28;
                            __subtask_fail = 4;
                            return SUBTASK;
                        }
                        //* (133) 		@send("gui", meinformagentstatus_s.post(currentPos, items, id) );
                        case 28: 
                        {
                            __state = 29;
                            agent.send("gui",meinformagentstatus_s.post(__local__17_6,__local__17_3,__local__17_1));
                            break;
                        }
                        //* (137) 		consoleIface.showConsoleDebug("A request-action event for step-id " + step + "-" + id + " states that " + getAgent().name() + " is currently at location " + currentPos.toString() + " with " + items + " pieces of gold");
                        case 29: 
                        {
                            __state = 30;
                            // Report current location, step number, and no of gold pieces carrying

                            consoleIface.showConsoleDebug("A request-action event for step-id " + __local__17_2 + "-" + __local__17_1 + " states that " + getAgent().name() + " is currently at location " + __local__17_6.toString() + " with " + __local__17_3 + " pieces of gold");
                            break;
                        }
                        ...
                        {
                            __state = 31;
                            agent.send("gui",eguidebugmessage_s.reportMessage(ID,"Step: " + __local__17_1 + " - Location: " + rmit.ai.clima.gui.grid.GridPoint.toString(__local__17_6) + " - Gold: " + __local__17_3));
                            break;
                        }
                        //* (146) 		@send("boss", eupdatebel_s.post(id,currentPos,cells,items));
                        case 31: 
                        {
                            __state = 32;
                            agent.send("boss",eupdatebel_s.post(__local__17_1,__local__17_6,__local__17_7,__local__17_3));
                            break;
                        }
                        ...
                        {
                            __state = 34;
                            agent.postEvent(eact_p.act());
                            break;
                        }
                        //* (157) 		bel_currentRequestActionId_dat.add(id,step);
                        case 34: 
                        {
                            __state = 35;
...
// (this needs to be updated last as it will trigger the next round of actions, see SendActionAndWait plan)
                            ...
                            bel_currentRequestActionId_dat.add(__local__17_1,__local__17_2);
                            break;
                        }
                        //* (72) 	#reasoning method
                        case 35: 
            ...
            throws java.lang.Exception
        {
            switch (__index) {
                case 0: 
                {
                    return (bel_currentPosition_dat.get(__local__17_8,__local__17_9));
                }
                case 1: 
                {
                ...
                case 2: 
                {
                    return (bel_numCarryingGold_dat.getCarryingGold(__local__17_10));
                }
            }
            aos.jack.jak.core.Jak.error("illegal Cursor Construction");
            return null;
            ...
            throws java.lang.Exception
        {
            switch (__index) {
                case 0: 
                {
                    return ((__local__17_8.as_int() != __local__17_4 || __local__17_9.as_int() != __local__17_5));
                }
            }
            aos.jack.jak.core.Jak.error("illegal test Construction");
            return false;
