            ...
            do {
                try {
                    ...
                    switch (__state) {
                        ...
                        //* (146)       @send( "boss", eupdatebel_s.post( id, currentPos, cells, items, getAgent().name() ));
                        case 28: 
                        {
                            __state = 29;
                            agent.send("boss",eupdatebel_s.post(__local__17_1,__local__17_6,__local__17_7,__local__17_3,getAgent().name()));
                            break;
                        }
