            ...
            do {
                try {
                    ...
                    switch (__state) {
                        ...
                        //* (47)         logical int $gridX, $gridY, $depotX, $depotY, $noSteps;
                        case 10: 
                        {
                            __breakLevel = 0;
                        ...
                        //* (48)         bel_simulationProp_dat.get($gridX, $gridY, $depotX, $depotY, $noSteps).removeAll();
                        case 11: 
                        {
                            __state = 12;
                        ...
                        //* (51)         bel_agentPositions_dat.get($agentName,$xPos,$yPos).removeAll();
                        case 14: 
                        {
                            __state = 15;
                        ...
                        //* (54)       	consoleIface.showConsoleDebug("Agent "+mesimend_h.from+ " reported the end of a simulation...");
                        case 15: 
                        {
                            __state = 16;
