            ...
            do {
                try {
                    ...
                    switch (__state) {
                        ...
                        //* (70)         logical int $lastActionSentId, $step;
                        case 10: 
                        {
                            __breakLevel = 0;
                        ...
                        //* (71) 		bel_currentRequestActionId_dat.query_step($step);
                        case 11: 
                        {
                            boolean __b;
                        ...
                        //* (74) 		@send("gui", eguidebugmessage_s.reportMessage(ID, "My current request action id is "+ $step.as_int()) );
                        case 12: 
                        {
                            __state = 13;
