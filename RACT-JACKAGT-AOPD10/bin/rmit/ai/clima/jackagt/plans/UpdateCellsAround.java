...
public class UpdateCellsAround extends aos.jack.jak.plan.Plan {
    ...
    class __bodyFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
        ...
        boolean __local__25_6;
        aos.jack.jak.logic.IntegerVariable __local__25_7;
        int __local__25_8;
        rmit.ai.clima.gui.grid.GridPoint __local__25_9;
        int __local__25_10;
            ...
            do {
                try {
                    ...
                    switch (__state) {
                        ...
                        //* (50)       int posX = eupdatebel_h.currentPos.x;
                        case 11: 
                        {
                        ...
                        //* (51)       int posY = eupdatebel_h.currentPos.y;
                        case 12: 
                        {
                        ...
                        //* (52)       Cell[] cells = eupdatebel_h.cells;	// the array of adjacent cells
                        case 13: 
                        {
                        ...
                        //* (61)       logical int $noGold; 	//  logical int to retrieve the amount of gold this agent is carrying
                        case 14: 
                        {
                            __local__25_7 = (aos.jack.jak.logic.IntegerVariable) __logic.new_variable(java.lang.Integer.TYPE);
                            __state = 15;
                            break;
                        }
                        //* (62)       for(int i=0; i < cells.length; i++) 
                        case 15: 
                        {
                            __local__25_8 = 0;
                            __state = 16;
                        ...
                        case 16: 
                        {
                            if (__local__25_8 < __local__25_3.length) 
                                __state = 17;
                             else 
                                __state = 35;
                            break;
                        }
                        //* (66)          locDir = cells[i].id;	// first, get its direction (e.g., n, nw, s, se, etc.)
                        case 17: 
                        {
                            __breakLevel = 4;
                            __state = 18;
...
// Calculate the exact point of cells[i]: store it in GridPoint loc
                            ...
                            __local__25_4 = __local__25_3[__local__25_8].id;
                            break;
                        }
                        //* (67)          GridPoint loc = GridPoint.getFromDir(posX, posY, locDir);
                        case 18: 
                        {
                            __local__25_9 = rmit.ai.clima.gui.grid.GridPoint.getFromDir(__local__25_1,__local__25_2,__local__25_4);
                            __state = 19;
                            break;
                        }
                        //* (69)          bFoundGold = false;	// Initially, assume the cell does not contain gold
                        case 19: 
                        {
                            __state = 20;
                            __local__25_5 = false;
                        ...
                        //* (72)          for(int j = 0; j < cells[i].marks.length; j++) 
                        case 21: 
                        {
                            __local__25_10 = 0;
                            __state = 22;
                        ...
                        case 22: 
                        {
                            if (__local__25_10 < __local__25_3[__local__25_8].marks.length) 
                                __state = 23;
                             else 
                                __state = 32;
                            break;
                        }
                        //* (76)             if( !(cells[i].marks[j].type.equalsIgnoreCase("unknown")) )
                        case 23: 
                        {
                            __breakLevel = 8;
                            if (!(__local__25_3[__local__25_8].marks[__local__25_10].type.equalsIgnoreCase("unknown"))) 
                                __state = 24;
                             else 
                                __state = 30;
                            break;
                        }
                        //* (80)                if( cells[i].marks[j].type.equalsIgnoreCase("obstacle") ) 
                        case 24: 
                        {
                            __breakLevel = 10;
                            if (__local__25_3[__local__25_8].marks[__local__25_10].type.equalsIgnoreCase("obstacle")) 
                                __state = 25;
                             else 
                                __state = 26;
                            break;
                        }
                        //* (82)                   bel_obstacleAt_dat.add(loc.x, loc.y, Cursor.TRUE);
                        case 25: 
                        {
                            __breakLevel = 12;
                            __state = 31;
                            bel_obstacleAt_dat.add(__local__25_9.x,__local__25_9.y,aos.jack.jak.cursor.Cursor.TRUE);
                            break;
                        }
                        //* (87)                   bel_obstacleAt_dat.add(loc.x, loc.y, Cursor.FALSE);
                        case 26: 
                        {
                            __breakLevel = 12;
                            __state = 27;
                            ...
                            bel_obstacleAt_dat.add(__local__25_9.x,__local__25_9.y,aos.jack.jak.cursor.Cursor.FALSE);
                            break;
                        }
                        //* (88)                   if( cells[i].marks[j].type.equalsIgnoreCase("gold"))
                        case 27: 
                        {
                            if (__local__25_3[__local__25_8].marks[__local__25_10].type.equalsIgnoreCase("gold")) 
                                __state = 28;
                             else 
                                __state = 31;
                            break;
                        ...
                        //* (91)                      bel_goldAt_dat.add(loc.x, loc.y, Cursor.TRUE);
                        case 29: 
                        {
                            __state = 31;
                            bel_goldAt_dat.add(__local__25_9.x,__local__25_9.y,aos.jack.jak.cursor.Cursor.TRUE);
                            break;
                        }
                        //* (100)                bUnknown = true;
                        case 30: 
                        ...
                        //* (103)          if(!bFoundGold && !bUnknown )
                        case 32: 
                        {
                            if (!__local__25_5 && !__local__25_6) 
                                __state = 33;
                             else 
                                __state = 34;
                            break;
                        }
                        //* (105)             bel_goldAt_dat.add(loc.x,loc.y, Cursor.FALSE);
                        case 33: 
                        {
                            __breakLevel = 6;
                            __state = 34;
                            bel_goldAt_dat.add(__local__25_9.x,__local__25_9.y,aos.jack.jak.cursor.Cursor.FALSE);
                            break;
                        }
                        //* (62)       for(int i=0; i < cells.length; i++) 
                        case 34: 
