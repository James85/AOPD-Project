            ...
            do {
                try {
                    ...
                    switch (__state) {
                        ...
                        //* (42) 	   @subtask(efindpath_p.post( epostplayeraction_h.playerName, $playerX.as_int(), $playerY.as_int(), $depotX.as_int(), $depotY.as_int() ));
                        case 10: 
                        {
                            __breakLevel = 0;
                        ...
                        //* (45)       if (bel_moveHint_dat.getByEndPoints($playerX.as_int(), $playerY.as_int(), $depotX.as_int(), $depotY.as_int(), $move ))
                        case 12: 
                        {
                            boolean __b;
                        ...
                        //* (47)          String baseName = epostplayeraction_h.playerName;
                        case 13: 
                        {
                            __breakLevel = 2;
                        ...
                        //* (48)          baseName = baseName.substring(0,baseName.indexOf("@"));
                        case 14: 
                        {
                            __state = 15;
                        ...
                        //* (49)          @send( baseName, meplayeraction_s.send( "moveTo", $move.as_string() ));
                        case 15: 
                        {
                            __state = 16;
