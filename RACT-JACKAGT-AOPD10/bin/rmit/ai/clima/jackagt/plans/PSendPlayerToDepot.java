...
public class PSendPlayerToDepot extends aos.jack.jak.plan.Plan {
    ...
    private static java.lang.String[] __tt__body = {
            "rmit/ai/clima/jackagt/plans/PSendPlayerToDepot.plan",
            "body",
            "42",
            "43",
            "44",
    ...
    {
        return aos.jack.jak.plan.PlanInstanceInfo.def[8];
    }
    
    public PSendPlayerToDepot()
    {
    }
    
    private PSendPlayerToDepot(aos.jack.jak.task.Task __t, rmit.ai.clima.jackagt.plans.PSendPlayerToDepot __env)
    {
        ...
        throws java.lang.Exception
    {
        switch (__index) {
            ...
            case 1: 
            {
                return (bel_simulationProp_dat.getDepotLoc($depotX,$depotY));
            }
            case 2: 
            {
    ...
    {
        return new rmit.ai.clima.jackagt.plans.PSendPlayerToDepot.__bodyFSM();
    }
    
    private PSendPlayerToDepot(rmit.ai.clima.jackagt.events.EPostPlayerAction __ev, aos.jack.jak.task.Task __t, rmit.ai.clima.jackagt.plans.PSendPlayerToDepot __env)
    {
        this(__t,__env);
    ...
    public aos.jack.jak.plan.Plan createPlan(aos.jack.jak.event.Event __e, aos.jack.jak.task.Task __t)
    {
        ...
        return new rmit.ai.clima.jackagt.plans.PSendPlayerToDepot(__e1,__t,this);
    }
    ...
    class __bodyFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
        aos.jack.jak.logic.StringVariable __local__25_0;
        java.lang.String __local__25_1;
            ...
            do {
                try {
                    ...
                    if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_PLANS) != 0) 
                        aos.util.logging.LogMsg.log(this,aos.jack.jak.core.Jak.LOG_PLANS,__task + "-PSendPlayerToDepot.body:" + java.lang.Integer.toString(__state));
                    if (__task.nsteps > 0) {
                        __task.nsteps-- ;
                        if (__task.nsteps == 0) 
                            agent.changeFocus();
                    ...
                    if (__state < 10) {
                        __status = super.stdrun(rmit.ai.clima.jackagt.plans.PSendPlayerToDepot.this,__status);
                    ...
                    switch (__state) {
                        default: 
                        {
                            aos.jack.jak.core.Jak.error("PSendPlayerToDepot.body: Illegal state");
                            return FAILED_STATE;
                        }
                        //* (42) 		if(!epostplayeraction_h.hasPath)
                        case 10: 
                        {
                            __breakLevel = 0;
                        ...
                        //* (43) 			@subtask(efindpath_p.post( epostplayeraction_h.playerName, $playerX.as_int(), $playerY.as_int(), $depotX.as_int(), $depotY.as_int() ));
                        case 11: 
                        {
                            __task.push(efindpath_p.post(epostplayeraction_h.playerName,$playerX.as_int(),$playerY.as_int(),$depotX.as_int(),$depotY.as_int()));
                            __state = -__state;
                            __subtask_pass = 12;
                            __subtask_fail = 4;
                            return SUBTASK;
                        }
                        //* (44) 		logical String $move;
                        case 12: 
                        {
                            __local__25_0 = (aos.jack.jak.logic.StringVariable) __logic.new_variable(java.lang.String.class);
                            __state = 13;
                            break;
                        }
                        //* (46) 		if (bel_moveHint_dat.getByEndPoints($playerX.as_int(), $playerY.as_int(), $depotX.as_int(), $depotY.as_int(), $move ))
                        case 13: 
                        {
                            boolean __b;
                        ...
                        //* (48) 			String baseName = epostplayeraction_h.playerName;
                        case 14: 
                        {
                            __breakLevel = 2;
                            __local__25_1 = epostplayeraction_h.playerName;
                            __state = 15;
                            break;
                        }
                        //* (49) 			baseName = baseName.substring(0,baseName.indexOf("@"));
                        case 15: 
                        {
                            __state = 16;
                            __local__25_1 = __local__25_1.substring(0,__local__25_1.indexOf("@"));
                            break;
                        }
                        //* (50) 			@send( baseName, meplayeraction_s.send( "moveTo", $move.as_string() ));
                        case 16: 
                        {
                            __state = 17;
                            agent.send(__local__25_1,meplayeraction_s.send("moveTo",__local__25_0.as_string()));
                            break;
                        }
                        //* (39) 	body()
                        case 17: 
            ...
            throws java.lang.Exception
        {
            switch (__index) {
                case 0: 
                {
                    return (bel_moveHint_dat.getByEndPoints($playerX.as_int(),$playerY.as_int(),$depotX.as_int(),$depotY.as_int(),__local__25_0));
                }
            }
            aos.jack.jak.core.Jak.error("illegal Cursor Construction");
            return null;
        ...
        {
            return rmit.ai.clima.jackagt.plans.PSendPlayerToDepot.this;
        }
        ...
        public void enter()
        {
            __trace = agent.trace("rmit.ai.clima.jackagt.plans.PSendPlayerToDepot.body");
        }
