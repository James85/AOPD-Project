...
public class MoveRandomly extends aos.jack.jak.plan.Plan {
        ...
        throws java.lang.Exception
    {
        switch (__index) {
            case 0: 
            {
                return (bel_numCarryingGold_dat.getCarryingGold($noGold));
            }
            case 1: 
            {
            ...
            case 2: 
            {
                return (bel_currentPosition_dat.get(x,y));
            }
            case 3: 
            {
                return (bel_goldAt_dat.checkIfGold(x.as_int(),y.as_int())).negate();
            }
            case 4: 
            {
                return (new aos.jack.jak.cursor.BinaryBoolOp(this,__logic,aos.jack.jak.cursor.BinaryBoolOp.OR,(short) 3,true,(short) 1,false));
            }
            case 5: 
            {
                return (new aos.jack.jak.cursor.BinaryBoolOp(this,__logic,aos.jack.jak.cursor.BinaryBoolOp.AND,(short) 2,true,(short) 4,true));
            }
            case 6: 
            {
                return (new aos.jack.jak.cursor.BinaryBoolOp(this,__logic,aos.jack.jak.cursor.BinaryBoolOp.OR,(short) 1,true,(short) 5,true));
            }
        }
        ...
        throws java.lang.Exception
    {
        switch (__index) {
            ...
            case 1: 
            {
                return (bel_goldAt_dat.checkUnknown(x.as_int(),y.as_int()));
            }
        }
            ...
            do {
                try {
                    ...
                    switch (__state) {
                        ...
                        //* (67) 		String dir = actions[ random.nextInt(4) ];	// pick a random direction
                        case 10: 
                        {
                            __breakLevel = 0;
                        ...
                        //* (69) 		consoleIface.showConsoleDebug("I will move randomly to this dir: " + dir);
                        case 11: 
                        {
                            __state = 12;
                            // pick a random direction

                            consoleIface.showConsoleDebug("I will move randomly to this dir: " + __local__18_0);
                            break;
                        }
                        //* (71) 		eexecuteclimaaction_p.post(dir);	// Post an ExecuteClimaAction event to execute the action in the server
                        case 12: 
                        {
