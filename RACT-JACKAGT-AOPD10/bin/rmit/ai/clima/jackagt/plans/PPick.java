...
public class PPick extends aos.jack.jak.plan.Plan {
...
/******** End PDT Design Block *** DO NOT EDIT IT *********/
    ...
    {
        return (e.action.equalsIgnoreCase("pick"));
    }
    ...
    private PPick(aos.jack.jak.task.Task __t, rmit.ai.clima.jackagt.plans.PPick __env)
    {
    ...
    {
        return new rmit.ai.clima.jackagt.plans.PPick.__bodyFSM();
    }
    
    private PPick(rmit.ai.clima.jackagt.events.MEPlayerAction __ev, aos.jack.jak.task.Task __t, rmit.ai.clima.jackagt.plans.PPick __env)
    {
        this(__t,__env);
    ...
    public aos.jack.jak.plan.Plan createPlan(aos.jack.jak.event.Event __e, aos.jack.jak.task.Task __t)
    {
        ...
        return new rmit.ai.clima.jackagt.plans.PPick(__e1,__t,this);
    }
    ...
    class __bodyFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
            ...
            do {
                try {
                    ...
                    if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_PLANS) != 0) 
                        aos.util.logging.LogMsg.log(this,aos.jack.jak.core.Jak.LOG_PLANS,__task + "-PPick.body:" + java.lang.Integer.toString(__state));
                    if (__task.nsteps > 0) {
                        __task.nsteps-- ;
                        if (__task.nsteps == 0) 
                            agent.changeFocus();
                    ...
                    if (__state < 10) {
                        __status = super.stdrun(rmit.ai.clima.jackagt.plans.PPick.this,__status);
                    ...
                    switch (__state) {
                        ...
                        //* (32) 	   System.out.println( "PICK" );
                        case 10: 
                        {
                            __breakLevel = 0;
                            __state = 11;
                            java.lang.System.out.println("PICK");
                            break;
                        }
                        //* (29) 	#reasoning method
                        case 11: 
        ...
        {
            return rmit.ai.clima.jackagt.plans.PPick.this;
        }
        ...
        public void enter()
        {
            __trace = agent.trace("rmit.ai.clima.jackagt.plans.PPick.body");
        }
