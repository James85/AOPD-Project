            ...
            do {
                try {
                    ...
                    switch (__state) {
                        ...
                        //* (37) 		int posX = eagentmoved_h.xCoord;
                        case 10: 
                        {
                            __breakLevel = 0;
                        ...
                        //* (38) 		int posY = eagentmoved_h.yCoord;
                        case 11: 
                        {
                        ...
                        //* (40) 		consoleIface.showConsoleDebug("Agent "+ getAgent().name()+" has just moved to location ("+posX+","+posY+")");
                        case 12: 
                        {
                            __state = 13;
                            consoleIface.showConsoleDebug("Agent " + getAgent().name() + " has just moved to location (" + __local__20_0 + "," + __local__20_1 + ")");
                            break;
                        }
                        //* (41) 		@send("boss", meinformagentstatus_s.post(getAgent().name(),new GridPoint(posX,posY)));
                        case 13: 
                        {
                            __state = 14;
