    ...
    class __bodyFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
            ...
            do {
                try {
                    ...
                    switch (__state) {
                        ...
                        //* (74)       for ( Cursor c = bel_obstacleAt_dat.get($x,$y).negate() ; c.next() ; ) 
                        case 15: 
                        {
                        ...
                        //* (78)       consoleIface.showConsoleDebug("Number of cells believed empty of obstacles: "+count);
                        case 18: 
                        {
                            __state = 19;
                        ...
                        //* (82)       for ( Cursor c = bel_obstacleAt_dat.get($x,$y) ; c.next() ; ) 
                        case 20: 
                        {
                        ...
                        //* (86)       consoleIface.showConsoleDebug("Number of believed obstructed cells: "+count);
                        case 23: 
                        {
                            __state = 24;
                        ...
                        //* (91)       bel_currentPosition_dat.get($xPos,$yPos);
                        case 25: 
                        {
                            boolean __b;
                            aos.jack.jak.cursor.Cursor __c = null;
                        ...
                        //* (97)          if(bel_obstacleAt_dat.check(tempPos.x,tempPos.y))
                        case 30: 
                        {
                            boolean __b;
                            aos.jack.jak.cursor.Cursor __c = null;
                        ...
                        //* (104)             if(bel_goldAt_dat.check(tempPos.x,tempPos.y))
                        case 32: 
                        {
                            boolean __b;
                            aos.jack.jak.cursor.Cursor __c = null;
            ...
            throws java.lang.Exception
        {
            switch (__index) {
                ...
                case 4: 
                {
                    return (bel_obstacleAt_dat.check(__local__3_11.x,__local__3_11.y));
                }
                case 5: 
                {
                    return (bel_goldAt_dat.check(__local__3_11.x,__local__3_11.y));
                }
            }
            aos.jack.jak.core.Jak.error("illegal Cursor Construction");
            return null;
