...
public class BPlayerState__Tuple extends aos.jack.jak.beliefset.Tuple implements aos.apib.Base, java.io.Serializable {
...
public BPlayerState__Tuple(boolean v)
{
    super();
    isFree = v;
}
...
public int hash(int __i)
{
  ...
  public BPlayerState__Tuple() {
    streamer.setup();
    if (!getStreamer().initialized) return;
    __init__BPlayerState__Tuple();
  }

  /** Automatically generated method. */
  void __init__BPlayerState__Tuple() {
	name = null;
	state = null;
  ...
  static class __SS extends aos.apib.StreamerSupport {
    BPlayerState__Tuple __def = null;
    ...
    protected void setup() {
      ...
      __def = (BPlayerState__Tuple)newInstance();
    ...
    protected void init() {
      setup();
      __def.__init__BPlayerState__Tuple();
    }
    ...
    public aos.apib.Base new_instance() {
      return new BPlayerState__Tuple();
    }

    /** JACOB method. */
    public aos.apib.Base[] new_array(int n) {
      return new BPlayerState__Tuple[n];
    }
    ...
    public boolean readField(aos.apib.InStream in, aos.apib.Base o,int i) {
      ...
      BPlayerState__Tuple v = (BPlayerState__Tuple)o;
      switch (i) {
      case 0:
   ...
   case 1:
	...
	break;
      ...
      default:
        if (i >= 0 && i <= 2) break;
        in.error("Reader for BPlayerState__Tuple: illegal field number:"+i);
        return false;
      }
      return true;
    }
   ...
   case 1:
	...
	break;
        ...
        default:
          if (i >= 0 && i <= 2) break;
          out.error("Writer for BPlayerState__Tuple: illegal field number:"+i);
          return false;
        }
      }
      return true;
