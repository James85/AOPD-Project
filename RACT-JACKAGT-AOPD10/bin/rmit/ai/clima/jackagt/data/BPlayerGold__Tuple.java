...
public class BPlayerGold__Tuple extends aos.jack.jak.beliefset.Tuple implements aos.apib.Base, java.io.Serializable {
...
public BPlayerGold__Tuple(boolean v)
{
    super();
    isFree = v;
}
...
public int hash(int __i)
{
  ...
  public BPlayerGold__Tuple() {
    streamer.setup();
    if (!getStreamer().initialized) return;
    __init__BPlayerGold__Tuple();
  }

  /** Automatically generated method. */
  void __init__BPlayerGold__Tuple() {
	agentName = null;
	goldAmount = 0;
  ...
  static class __SS extends aos.apib.StreamerSupport {
    ...
    protected void setup() {
      ...
      __def = (BPlayerGold__Tuple)newInstance();
    ...
    protected void init() {
      setup();
      __def.__init__BPlayerGold__Tuple();
    }
    ...
    public aos.apib.Base new_instance() {
      return new BPlayerGold__Tuple();
    }

    /** JACOB method. */
    public aos.apib.Base[] new_array(int n) {
      return new BPlayerGold__Tuple[n];
    }
    ...
    public boolean readField(aos.apib.InStream in, aos.apib.Base o,int i) {
      ...
      BPlayerGold__Tuple v = (BPlayerGold__Tuple)o;
      switch (i) {
      case 0:
	v.agentName = in.getString(true);
	break;
   case 1:
	v.goldAmount = in.getInt();
	break;
      case 2:
      ...
      default:
        if (i >= 0 && i <= 2) break;
        in.error("Reader for BPlayerGold__Tuple: illegal field number:"+i);
        return false;
      }
      return true;
    }
	...
	break;
   case 1:
	out.putInt(v.goldAmount, i, __def.goldAmount, this);
	break;
        case 2:
        ...
        default:
          if (i >= 0 && i <= 2) break;
          out.error("Writer for BPlayerGold__Tuple: illegal field number:"+i);
          return false;
        }
      }
      return true;
	...
	if (v.goldAmount != __def.goldAmount) return false;
