...
public class GoldAt extends aos.jack.jak.beliefset.OpenWorld {
    ...
    public aos.jack.jak.cursor.Cursor checkIfGoldInRow(int yCoord)
        throws aos.jack.jak.beliefset.BeliefSetException
    {
        rmit.ai.clima.jackagt.data.GoldAt.__complex_14 __c = new rmit.ai.clima.jackagt.data.GoldAt.__complex_14(yCoord);
        try {
    ...
    public boolean checkUnknown(int x, int y)
        throws aos.jack.jak.beliefset.BeliefSetException
    {
        rmit.ai.clima.jackagt.data.GoldAt.__complex_15 __c = new rmit.ai.clima.jackagt.data.GoldAt.__complex_15(x,y);
        try {
            return __c.__complex_15_checkUnknown();
        }
        catch (java.lang.Exception __e) {
    ...
    class __complex_14 extends aos.jack.plugin.view.rt.CleanupCursor {
            ...
            throws java.lang.Exception
        {
            switch (__index) {
                ...
                case 2: 
                {
                    return (checkIfGold(__local_2.as_int(),__local_3.as_int()));
                }
                case 3: 
                {
            ...
            throws java.lang.Exception
        {
            switch (__index) {
                case 0: 
                {
                    return (__local_3.as_int() == yCoord);
                }
            }
            aos.jack.jak.core.Jak.error("illegal test Construction");
            return false;
        ...
        public __complex_14(int yCoord)
        {
            super();
            this.yCoord = yCoord;
        }
    ...
    class __complex_15 extends aos.jack.plugin.view.rt.CleanupCursor {
            ...
            throws java.lang.Exception
        {
            switch (__index) {
                case 0: 
                {
                    return (checkIfGold(x,y));
                }
                case 1: 
                {
                    return (checkIfGold(x,y).negate());
                }
            }
            aos.jack.jak.core.Jak.error("illegal Cursor Construction");
            return null;
        ...
        public __complex_15(int x, int y)
        {
            super();
            this.x = x;
            this.y = y;
        ...
        public boolean __complex_15_checkUnknown()
            throws java.lang.Exception
        {
            if (genCursor(0).next()) {
                return false;
