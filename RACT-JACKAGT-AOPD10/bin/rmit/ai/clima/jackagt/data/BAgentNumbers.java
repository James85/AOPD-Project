...
public class BAgentNumbers extends aos.jack.jak.beliefset.ClosedWorld {
    static public rmit.ai.clima.jackagt.data.BAgentNumbers__Tuple __hole = new rmit.ai.clima.jackagt.data.BAgentNumbers__Tuple(true);
    public rmit.ai.clima.jackagt.data.BAgentNumbers__Tuple[][] __tables;
    ...
    {
        rmit.ai.clima.jackagt.data.BAgentNumbers__Tuple __t = new rmit.ai.clima.jackagt.data.BAgentNumbers__Tuple();
        rmit.ai.clima.jackagt.data.BAgentNumbers.__Cursor __c = new rmit.ai.clima.jackagt.data.BAgentNumbers.__Cursor(__t);
        if (!__v0.check_unifiable(StringType)) 
            throw new aos.jack.jak.beliefset.BeliefSetException("BAgentNumbers:get:OO: arg 0 agentName Incorrect Variable type");
        if (__v0.isGround()) {
            try {
                __t.agentName = __v0.as_string();
            }
            catch (java.lang.Exception e) {
                throw new aos.jack.jak.beliefset.BeliefSetException("BAgentNumbers:get:OO: got " + e.toString());
            }
        }
         else 
            __c.agentName = __v0;
        if (!__v1.check_unifiable(java.lang.Integer.TYPE)) 
            throw new aos.jack.jak.beliefset.BeliefSetException("BAgentNumbers:get:OO: arg 1 agentNo Incorrect Variable type");
        if (__v1.isGround()) {
            try {
                __t.agentNo = __v1.as_int();
            }
            catch (java.lang.Exception e) {
                throw new aos.jack.jak.beliefset.BeliefSetException("BAgentNumbers:get:OO: got " + e.toString());
            }
    ...
    public aos.jack.jak.beliefset.BeliefSetCursor getNo(java.lang.String __v0, aos.jack.jak.logic.IntegerVariable __v1)
        throws aos.jack.jak.beliefset.BeliefSetException
    {
        rmit.ai.clima.jackagt.data.BAgentNumbers__Tuple __t = new rmit.ai.clima.jackagt.data.BAgentNumbers__Tuple();
        rmit.ai.clima.jackagt.data.BAgentNumbers.__Cursor __c = new rmit.ai.clima.jackagt.data.BAgentNumbers.__Cursor(__t);
        __t.agentName = __v0;
        if (!__v1.check_unifiable(java.lang.Integer.TYPE)) 
            throw new aos.jack.jak.beliefset.BeliefSetException("BAgentNumbers:getNo:IO: arg 1 agentNo Incorrect Variable type");
        if (__v1.isGround()) {
            try {
                __t.agentNo = __v1.as_int();
            }
            catch (java.lang.Exception e) {
                throw new aos.jack.jak.beliefset.BeliefSetException("BAgentNumbers:getNo:IO: got " + e.toString());
            }
        }
         else 
            __c.agentNo = __v1;
    ...
    {
        return new rmit.ai.clima.jackagt.data.BAgentNumbers__Tuple();
    }
    ...
    {
        return new rmit.ai.clima.jackagt.data.BAgentNumbers__Tuple[t];
    }
    ...
    {
        __tables = (rmit.ai.clima.jackagt.data.BAgentNumbers__Tuple[][]) t;
    }
    
    public aos.jack.jak.beliefset.BeliefSetCursor newCursor(aos.jack.jak.beliefset.Tuple __t)
    {
        if (__t instanceof rmit.ai.clima.jackagt.data.BAgentNumbers__Tuple) 
            return new rmit.ai.clima.jackagt.data.BAgentNumbers.__Cursor((rmit.ai.clima.jackagt.data.BAgentNumbers__Tuple) __t);
        return null;
    }
    ...
    public BAgentNumbers()
    {
    }
    
    public BAgentNumbers(java.lang.String n)
    {
        super();
        read(n);
    }
    ...
    class __Cursor extends aos.jack.jak.beliefset.ClosedWorldCursor {
        public rmit.ai.clima.jackagt.data.BAgentNumbers__Tuple __tuple = null;
        public aos.jack.jak.logic.Variable agentName;
        public aos.jack.jak.logic.Variable agentNo;
        public __Cursor()
        {
            __tuple = __hole;
        }
        
        public __Cursor(rmit.ai.clima.jackagt.data.BAgentNumbers__Tuple __t)
        {
            super();
            __tuple = __t;
        }
        ...
        {
            rmit.ai.clima.jackagt.data.BAgentNumbers__Tuple[] __tab = __tables[__ti];
            rmit.ai.clima.jackagt.data.BAgentNumbers__Tuple __t;
            int __sz = __tab.length;
            int __i;
            if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_DB) != 0) {
                aos.jack.jak.core.Jak.log.log("BAgentNumbers__Tuple:match:" + __ti + ":" + __st + ":" + __c + ":" + __k + ":" + __ind);
                ...
                aos.jack.jak.core.Jak.log.log("  agentNo:" + agentNo);
            }
            for (__i = __st; __c > 0; __i = (__i + 1) % __sz, __c-- ) {
                ...
                try {
                    ...
                    if (__k) 
                        return __i;
                    if (agentNo == null) {
                        if (__tuple.agentNo != __t.agentNo) 
                            continue;
                    }
                     else {
                        if (!agentNo.unify(__t.agentNo)) 
                            continue;
                    }
                }
                catch (java.lang.Exception e) {
        ...
        public aos.jack.jak.logic.ChoicePoint getChoicePoint()
        {
            ...
            if (agentNo != null) 
                return agentNo.getEnv().newChoicePoint();
            return null;
        }
