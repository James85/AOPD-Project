...
public class BPlayer__Tuple extends aos.jack.jak.beliefset.Tuple implements aos.apib.Base, java.io.Serializable {
...
public BPlayer__Tuple(boolean v)
{
    super();
    isFree = v;
}
...
public int hash(int __i)
{
  ...
  public BPlayer__Tuple() {
    streamer.setup();
    if (!getStreamer().initialized) return;
    __init__BPlayer__Tuple();
  }

  /** Automatically generated method. */
  void __init__BPlayer__Tuple() {
	name = null;
  ...
  static class __SS extends aos.apib.StreamerSupport {
    ...
    protected void setup() {
      ...
      __def = (BPlayer__Tuple)newInstance();
    ...
    public aos.apib.Base new_instance() {
      return new BPlayer__Tuple();
    }

    /** JACOB method. */
    public aos.apib.Base[] new_array(int n) {
      return new BPlayer__Tuple[n];
    }
    ...
    public boolean readField(aos.apib.InStream in, aos.apib.Base o,int i) {
      ...
      BPlayer__Tuple v = (BPlayer__Tuple)o;
      switch (i) {
      case 0:
	...
	break;
      ...
      default:
        if (i >= 0 && i <= 1) break;
        in.error("Reader for BPlayer__Tuple: illegal field number:"+i);
        return false;
      }
      return true;
    }
	...
	break;
        ...
        default:
          if (i >= 0 && i <= 1) break;
          out.error("Writer for BPlayer__Tuple: illegal field number:"+i);
          return false;
        }
      }
      return true;
