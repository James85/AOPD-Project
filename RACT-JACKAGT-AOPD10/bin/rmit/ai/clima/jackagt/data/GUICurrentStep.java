...
public class GUICurrentStep extends aos.jack.jak.beliefset.ClosedWorld {
    ...
    public int getStep(int agentNum)
        throws aos.jack.jak.beliefset.BeliefSetException
    {
        rmit.ai.clima.jackagt.data.GUICurrentStep.__complex_12 __c = new rmit.ai.clima.jackagt.data.GUICurrentStep.__complex_12(agentNum);
        try {
            return __c.__complex_12_getStep();
        }
    ...
    class __complex_12 extends aos.jack.plugin.view.rt.CleanupCursor {
        ...
        public __complex_12(int agentNum)
        {
            super();
            this.agentNum = agentNum;
        }
        
        public int __complex_12_getStep()
            throws java.lang.Exception
        {
