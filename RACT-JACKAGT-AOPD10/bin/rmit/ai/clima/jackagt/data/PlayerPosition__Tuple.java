...
public class PlayerPosition__Tuple extends aos.jack.jak.beliefset.Tuple implements aos.apib.Base, java.io.Serializable {
...
public PlayerPosition__Tuple(boolean v)
{
    super();
    isFree = v;
}
...
public int hash(int __i)
{
  ...
  public PlayerPosition__Tuple() {
    streamer.setup();
    if (!getStreamer().initialized) return;
    __init__PlayerPosition__Tuple();
  }

  /** Automatically generated method. */
  void __init__PlayerPosition__Tuple() {
	agentName = null;
	posX = 0;
	posY = 0;
  ...
  static class __SS extends aos.apib.StreamerSupport {
    PlayerPosition__Tuple __def = null;
    ...
    protected void setup() {
      ...
      __def = (PlayerPosition__Tuple)newInstance();
    ...
    protected void init() {
      setup();
      __def.__init__PlayerPosition__Tuple();
    }
    ...
    public aos.apib.Base new_instance() {
      return new PlayerPosition__Tuple();
    }

    /** JACOB method. */
    public aos.apib.Base[] new_array(int n) {
      return new PlayerPosition__Tuple[n];
    }
    ...
    public boolean readField(aos.apib.InStream in, aos.apib.Base o,int i) {
      ...
      PlayerPosition__Tuple v = (PlayerPosition__Tuple)o;
      switch (i) {
      case 0:
   ...
   case 2:
	...
	break;
      ...
      default:
        if (i >= 0 && i <= 3) break;
        in.error("Reader for PlayerPosition__Tuple: illegal field number:"+i);
        return false;
      }
      return true;
    }
   ...
   case 2:
	...
	break;
        ...
        default:
          if (i >= 0 && i <= 3) break;
          out.error("Writer for PlayerPosition__Tuple: illegal field number:"+i);
          return false;
        }
      }
      return true;
