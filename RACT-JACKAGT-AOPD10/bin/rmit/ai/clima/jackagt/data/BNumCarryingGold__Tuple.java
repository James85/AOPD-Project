...
public class BNumCarryingGold__Tuple extends aos.jack.jak.beliefset.Tuple implements aos.apib.Base, java.io.Serializable {
...
public BNumCarryingGold__Tuple(boolean v)
{
    super();
    isFree = v;
}
...
{
    return "BNumCarryingGold__Tuple";
}
...
public int hash(int __i)
{
  ...
  public BNumCarryingGold__Tuple() {
    streamer.setup();
    if (!getStreamer().initialized) return;
    __init__BNumCarryingGold__Tuple();
  }

  /** Automatically generated method. */
  void __init__BNumCarryingGold__Tuple() {
	goldCount = 0;
  ...
  static class __SS extends aos.apib.StreamerSupport {
    BNumCarryingGold__Tuple __def = null;
    ...
    public __SS() {
      __type = "BNumCarryingGold__Tuple";
      __icon = null;
    ...
    protected void setup() {
      ...
      __def = (BNumCarryingGold__Tuple)newInstance();
    ...
    protected void init() {
      setup();
      __def.__init__BNumCarryingGold__Tuple();
    }
    ...
    public aos.apib.Base new_instance() {
      return new BNumCarryingGold__Tuple();
    }

    /** JACOB method. */
    public aos.apib.Base[] new_array(int n) {
      return new BNumCarryingGold__Tuple[n];
    }
    ...
    public boolean readField(aos.apib.InStream in, aos.apib.Base o,int i) {
      ...
      BNumCarryingGold__Tuple v = (BNumCarryingGold__Tuple)o;
      switch (i) {
      case 0:
	...
	break;
      ...
      default:
        if (i >= 0 && i <= 1) break;
        in.error("Reader for BNumCarryingGold__Tuple: illegal field number:"+i);
        return false;
      }
      return true;
    }
	...
	break;
        ...
        default:
          if (i >= 0 && i <= 1) break;
          out.error("Writer for BNumCarryingGold__Tuple: illegal field number:"+i);
          return false;
        }
      }
      return true;
