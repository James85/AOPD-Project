...
public class CurrentRequestActionId__Tuple extends aos.jack.jak.beliefset.Tuple implements aos.apib.Base, java.io.Serializable {
...
public CurrentRequestActionId__Tuple(boolean v)
{
    super();
    isFree = v;
}
...
{
    return "CurrentRequestActionId__Tuple";
}
...
public int hash(int __i)
{
  ...
  public CurrentRequestActionId__Tuple() {
    streamer.setup();
    if (!getStreamer().initialized) return;
    __init__CurrentRequestActionId__Tuple();
  }

  /** Automatically generated method. */
  void __init__CurrentRequestActionId__Tuple() {
	id = 0;
	step = 0;
  ...
  static class __SS extends aos.apib.StreamerSupport {
    CurrentRequestActionId__Tuple __def = null;
    ...
    public __SS() {
      __type = "CurrentRequestActionId__Tuple";
      __icon = null;
    ...
    protected void setup() {
      ...
      __def = (CurrentRequestActionId__Tuple)newInstance();
    ...
    protected void init() {
      setup();
      __def.__init__CurrentRequestActionId__Tuple();
    }
    ...
    public aos.apib.Base new_instance() {
      return new CurrentRequestActionId__Tuple();
    }

    /** JACOB method. */
    public aos.apib.Base[] new_array(int n) {
      return new CurrentRequestActionId__Tuple[n];
    }
    ...
    public boolean readField(aos.apib.InStream in, aos.apib.Base o,int i) {
      ...
      CurrentRequestActionId__Tuple v = (CurrentRequestActionId__Tuple)o;
      switch (i) {
      case 0:
	v.id = in.getInt();
	break;
   case 1:
	...
	break;
      ...
      default:
        if (i >= 0 && i <= 2) break;
        in.error("Reader for CurrentRequestActionId__Tuple: illegal field number:"+i);
        return false;
      }
      return true;
    }
   ...
   case 1:
	...
	break;
        ...
        default:
          if (i >= 0 && i <= 2) break;
          out.error("Writer for CurrentRequestActionId__Tuple: illegal field number:"+i);
          return false;
        }
      }
      return true;
