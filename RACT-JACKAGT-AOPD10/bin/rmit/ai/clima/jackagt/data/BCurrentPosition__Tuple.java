...
public class BCurrentPosition__Tuple extends aos.jack.jak.beliefset.Tuple implements aos.apib.Base, java.io.Serializable {
...
public BCurrentPosition__Tuple(boolean v)
{
    super();
    isFree = v;
}
...
{
    return "BCurrentPosition__Tuple";
}
...
public int hash(int __i)
{
  ...
  public BCurrentPosition__Tuple() {
    streamer.setup();
    if (!getStreamer().initialized) return;
    __init__BCurrentPosition__Tuple();
  }

  /** Automatically generated method. */
  void __init__BCurrentPosition__Tuple() {
	posX = 0;
	posY = 0;
  ...
  static class __SS extends aos.apib.StreamerSupport {
    BCurrentPosition__Tuple __def = null;
    ...
    public __SS() {
      __type = "BCurrentPosition__Tuple";
      __icon = null;
    ...
    protected void setup() {
      ...
      __def = (BCurrentPosition__Tuple)newInstance();
    ...
    protected void init() {
      setup();
      __def.__init__BCurrentPosition__Tuple();
    }
    ...
    public aos.apib.Base new_instance() {
      return new BCurrentPosition__Tuple();
    }

    /** JACOB method. */
    public aos.apib.Base[] new_array(int n) {
      return new BCurrentPosition__Tuple[n];
    }
    ...
    public boolean readField(aos.apib.InStream in, aos.apib.Base o,int i) {
      ...
      BCurrentPosition__Tuple v = (BCurrentPosition__Tuple)o;
      switch (i) {
      case 0:
	v.posX = in.getInt();
	break;
   case 1:
	...
	break;
      ...
      default:
        if (i >= 0 && i <= 2) break;
        in.error("Reader for BCurrentPosition__Tuple: illegal field number:"+i);
        return false;
      }
      return true;
    }
   ...
   case 1:
	...
	break;
        ...
        default:
          if (i >= 0 && i <= 2) break;
          out.error("Writer for BCurrentPosition__Tuple: illegal field number:"+i);
          return false;
        }
      }
      return true;
