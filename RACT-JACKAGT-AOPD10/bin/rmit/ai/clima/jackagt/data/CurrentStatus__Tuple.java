...
public class CurrentStatus__Tuple extends aos.jack.jak.beliefset.Tuple implements aos.apib.Base, java.io.Serializable {
...
public CurrentStatus__Tuple(boolean v)
{
    super();
    isFree = v;
}
...
public int hash(int __i)
{
  ...
  public CurrentStatus__Tuple() {
    streamer.setup();
    if (!getStreamer().initialized) return;
    __init__CurrentStatus__Tuple();
  }

  /** Automatically generated method. */
  void __init__CurrentStatus__Tuple() {
	debugConsole = false;
	debugGUI = false;
  ...
  static class __SS extends aos.apib.StreamerSupport {
    CurrentStatus__Tuple __def = null;
    ...
    protected void setup() {
      ...
      __def = (CurrentStatus__Tuple)newInstance();
    ...
    protected void init() {
      setup();
      __def.__init__CurrentStatus__Tuple();
    }
    ...
    public aos.apib.Base new_instance() {
      return new CurrentStatus__Tuple();
    }

    /** JACOB method. */
    public aos.apib.Base[] new_array(int n) {
      return new CurrentStatus__Tuple[n];
    }
    ...
    public boolean readField(aos.apib.InStream in, aos.apib.Base o,int i) {
      ...
      CurrentStatus__Tuple v = (CurrentStatus__Tuple)o;
      switch (i) {
      case 0:
	v.debugConsole = in.getBool();
	break;
   case 1:
	v.debugGUI = in.getBool();
	break;
      case 2:
      ...
      default:
        if (i >= 0 && i <= 2) break;
        in.error("Reader for CurrentStatus__Tuple: illegal field number:"+i);
        return false;
      }
      return true;
    }
    ...
    public boolean write(aos.apib.OutStream out, aos.apib.Base o) {
      ...
      while ((i = out.nextField(i, this)) >= 0) {
        switch (i) {
      case 0:
	out.putBool(v.debugConsole, i, __def.debugConsole, this);
	break;
   case 1:
	out.putBool(v.debugGUI, i, __def.debugGUI, this);
	break;
        case 2:
        ...
        default:
          if (i >= 0 && i <= 2) break;
          out.error("Writer for CurrentStatus__Tuple: illegal field number:"+i);
          return false;
        }
      }
      return true;
	...
	if (v.debugConsole != __def.debugConsole) return false;
	if (v.debugGUI != __def.debugGUI) return false;
