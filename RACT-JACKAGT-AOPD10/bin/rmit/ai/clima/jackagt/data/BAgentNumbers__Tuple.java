...
public class BAgentNumbers__Tuple extends aos.jack.jak.beliefset.Tuple implements aos.apib.Base, java.io.Serializable {
...
public BAgentNumbers__Tuple(boolean v)
{
    super();
    isFree = v;
}
...
public int hash(int __i)
{
  ...
  public BAgentNumbers__Tuple() {
    streamer.setup();
    if (!getStreamer().initialized) return;
    __init__BAgentNumbers__Tuple();
  }

  /** Automatically generated method. */
  void __init__BAgentNumbers__Tuple() {
	agentName = null;
	agentNo = 0;
  ...
  static class __SS extends aos.apib.StreamerSupport {
    BAgentNumbers__Tuple __def = null;
    ...
    protected void setup() {
      ...
      __def = (BAgentNumbers__Tuple)newInstance();
    ...
    protected void init() {
      setup();
      __def.__init__BAgentNumbers__Tuple();
    }
    ...
    public aos.apib.Base new_instance() {
      return new BAgentNumbers__Tuple();
    }

    /** JACOB method. */
    public aos.apib.Base[] new_array(int n) {
      return new BAgentNumbers__Tuple[n];
    }
    ...
    public boolean readField(aos.apib.InStream in, aos.apib.Base o,int i) {
      ...
      BAgentNumbers__Tuple v = (BAgentNumbers__Tuple)o;
      switch (i) {
      case 0:
   ...
   case 1:
	...
	break;
      ...
      default:
        if (i >= 0 && i <= 2) break;
        in.error("Reader for BAgentNumbers__Tuple: illegal field number:"+i);
        return false;
      }
      return true;
    }
   ...
   case 1:
	...
	break;
        ...
        default:
          if (i >= 0 && i <= 2) break;
          out.error("Writer for BAgentNumbers__Tuple: illegal field number:"+i);
          return false;
        }
      }
      return true;
