...
public class PlayerPerceptReceived__Tuple extends aos.jack.jak.beliefset.Tuple implements aos.apib.Base, java.io.Serializable {
...
public PlayerPerceptReceived__Tuple(boolean v)
{
    super();
    isFree = v;
}
...
{
    return "PlayerPerceptReceived__Tuple";
}
...
public int hash(int __i)
{
  ...
  public PlayerPerceptReceived__Tuple() {
    streamer.setup();
    if (!getStreamer().initialized) return;
    __init__PlayerPerceptReceived__Tuple();
  }

  /** Automatically generated method. */
  void __init__PlayerPerceptReceived__Tuple() {
	agentName = null;
  ...
  static class __SS extends aos.apib.StreamerSupport {
    PlayerPerceptReceived__Tuple __def = null;
    ...
    public __SS() {
      __type = "PlayerPerceptReceived__Tuple";
      __icon = null;
    ...
    protected void setup() {
      ...
      __def = (PlayerPerceptReceived__Tuple)newInstance();
    ...
    protected void init() {
      setup();
      __def.__init__PlayerPerceptReceived__Tuple();
    }
    ...
    public aos.apib.Base new_instance() {
      return new PlayerPerceptReceived__Tuple();
    }

    /** JACOB method. */
    public aos.apib.Base[] new_array(int n) {
      return new PlayerPerceptReceived__Tuple[n];
    }
    ...
    public boolean readField(aos.apib.InStream in, aos.apib.Base o,int i) {
      ...
      PlayerPerceptReceived__Tuple v = (PlayerPerceptReceived__Tuple)o;
      switch (i) {
      case 0:
	...
	break;
      ...
      default:
        if (i >= 0 && i <= 1) break;
        in.error("Reader for PlayerPerceptReceived__Tuple: illegal field number:"+i);
        return false;
      }
      return true;
    }
	...
	break;
        ...
        default:
          if (i >= 0 && i <= 1) break;
          out.error("Writer for PlayerPerceptReceived__Tuple: illegal field number:"+i);
          return false;
        }
      }
      return true;
