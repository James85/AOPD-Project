...
public class AgentPositions__Tuple extends aos.jack.jak.beliefset.Tuple implements aos.apib.Base, java.io.Serializable {
...
public AgentPositions__Tuple(boolean v)
{
    super();
    isFree = v;
}
...
public int hash(int __i)
{
  ...
  public AgentPositions__Tuple() {
    streamer.setup();
    if (!getStreamer().initialized) return;
    __init__AgentPositions__Tuple();
  }

  /** Automatically generated method. */
  void __init__AgentPositions__Tuple() {
	agentName = null;
	posX = 0;
	posY = 0;
  ...
  static class __SS extends aos.apib.StreamerSupport {
    AgentPositions__Tuple __def = null;
    ...
    protected void setup() {
      ...
      __def = (AgentPositions__Tuple)newInstance();
    ...
    protected void init() {
      setup();
      __def.__init__AgentPositions__Tuple();
    }
    ...
    public aos.apib.Base new_instance() {
      return new AgentPositions__Tuple();
    }

    /** JACOB method. */
    public aos.apib.Base[] new_array(int n) {
      return new AgentPositions__Tuple[n];
    }
    ...
    public boolean readField(aos.apib.InStream in, aos.apib.Base o,int i) {
      ...
      AgentPositions__Tuple v = (AgentPositions__Tuple)o;
      switch (i) {
      case 0:
   ...
   case 2:
	...
	break;
      ...
      default:
        if (i >= 0 && i <= 3) break;
        in.error("Reader for AgentPositions__Tuple: illegal field number:"+i);
        return false;
      }
      return true;
    }
   ...
   case 2:
	...
	break;
        ...
        default:
          if (i >= 0 && i <= 3) break;
          out.error("Writer for AgentPositions__Tuple: illegal field number:"+i);
          return false;
        }
      }
      return true;
