...
public class BPlayerPerceptReceived__Tuple extends aos.jack.jak.beliefset.Tuple implements aos.apib.Base, java.io.Serializable {
...
public BPlayerPerceptReceived__Tuple(boolean v)
{
    super();
    isFree = v;
}
...
{
    return "BPlayerPerceptReceived__Tuple";
}
...
public int hash(int __i)
{
  ...
  public BPlayerPerceptReceived__Tuple() {
    streamer.setup();
    if (!getStreamer().initialized) return;
    __init__BPlayerPerceptReceived__Tuple();
  }

  /** Automatically generated method. */
  void __init__BPlayerPerceptReceived__Tuple() {
	agentName = null;
  ...
  static class __SS extends aos.apib.StreamerSupport {
    BPlayerPerceptReceived__Tuple __def = null;
    ...
    public __SS() {
      __type = "BPlayerPerceptReceived__Tuple";
      __icon = null;
    ...
    protected void setup() {
      ...
      __def = (BPlayerPerceptReceived__Tuple)newInstance();
    ...
    protected void init() {
      setup();
      __def.__init__BPlayerPerceptReceived__Tuple();
    }
    ...
    public aos.apib.Base new_instance() {
      return new BPlayerPerceptReceived__Tuple();
    }

    /** JACOB method. */
    public aos.apib.Base[] new_array(int n) {
      return new BPlayerPerceptReceived__Tuple[n];
    }
    ...
    public boolean readField(aos.apib.InStream in, aos.apib.Base o,int i) {
      ...
      BPlayerPerceptReceived__Tuple v = (BPlayerPerceptReceived__Tuple)o;
      switch (i) {
      case 0:
	...
	break;
      ...
      default:
        if (i >= 0 && i <= 1) break;
        in.error("Reader for BPlayerPerceptReceived__Tuple: illegal field number:"+i);
        return false;
      }
      return true;
    }
	...
	break;
        ...
        default:
          if (i >= 0 && i <= 1) break;
          out.error("Writer for BPlayerPerceptReceived__Tuple: illegal field number:"+i);
          return false;
        }
      }
      return true;
