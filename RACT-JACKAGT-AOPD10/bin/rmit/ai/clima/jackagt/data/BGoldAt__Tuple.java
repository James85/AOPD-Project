...
public class BGoldAt__Tuple extends aos.jack.jak.beliefset.Tuple implements aos.apib.Base, java.io.Serializable {
...
public BGoldAt__Tuple(boolean v)
{
    super();
    isFree = v;
}
...
public int hash(int __i)
{
  ...
  public BGoldAt__Tuple() {
    streamer.setup();
    if (!getStreamer().initialized) return;
    __init__BGoldAt__Tuple();
  }

  /** Automatically generated method. */
  void __init__BGoldAt__Tuple() {
	xCoord = 0;
	yCoord = 0;
  ...
  static class __SS extends aos.apib.StreamerSupport {
    ...
    protected void setup() {
      ...
      __def = (BGoldAt__Tuple)newInstance();
    ...
    public aos.apib.Base new_instance() {
      return new BGoldAt__Tuple();
    }

    /** JACOB method. */
    public aos.apib.Base[] new_array(int n) {
      return new BGoldAt__Tuple[n];
    }
    ...
    public boolean readField(aos.apib.InStream in, aos.apib.Base o,int i) {
      ...
      BGoldAt__Tuple v = (BGoldAt__Tuple)o;
      switch (i) {
      case 0:
	v.xCoord = in.getInt();
	break;
   case 1:
	...
	break;
      ...
      default:
        if (i >= 0 && i <= 2) break;
        in.error("Reader for BGoldAt__Tuple: illegal field number:"+i);
        return false;
      }
      return true;
    }
   ...
   case 1:
	...
	break;
        ...
        default:
          if (i >= 0 && i <= 2) break;
          out.error("Writer for BGoldAt__Tuple: illegal field number:"+i);
          return false;
        }
      }
      return true;
