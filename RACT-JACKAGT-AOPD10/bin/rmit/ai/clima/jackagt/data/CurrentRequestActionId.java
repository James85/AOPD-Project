...
public class CurrentRequestActionId extends aos.jack.jak.beliefset.ClosedWorld {
    ...
    public aos.jack.jak.cursor.Cursor query_id(aos.jack.jak.logic.IntegerVariable $id)
        throws aos.jack.jak.beliefset.BeliefSetException
    {
        rmit.ai.clima.jackagt.data.CurrentRequestActionId.__complex_7 __c = new rmit.ai.clima.jackagt.data.CurrentRequestActionId.__complex_7($id);
        try {
            return __c.setCursor(__c.__complex_7_query_id());
        }
    ...
    public aos.jack.jak.cursor.Cursor query_step(aos.jack.jak.logic.IntegerVariable $step)
        throws aos.jack.jak.beliefset.BeliefSetException
    {
        rmit.ai.clima.jackagt.data.CurrentRequestActionId.__complex_8 __c = new rmit.ai.clima.jackagt.data.CurrentRequestActionId.__complex_8($step);
        try {
            return __c.setCursor(__c.__complex_8_query_step());
        }
        catch (java.lang.Exception __e) {
    ...
    public aos.jack.jak.cursor.Cursor check_id(int id)
        throws aos.jack.jak.beliefset.BeliefSetException
    {
        rmit.ai.clima.jackagt.data.CurrentRequestActionId.__complex_9 __c = new rmit.ai.clima.jackagt.data.CurrentRequestActionId.__complex_9(id);
        try {
            return __c.setCursor(__c.__complex_9_check_id());
        }
        catch (java.lang.Exception __e) {
    ...
    public aos.jack.jak.cursor.Cursor check_step(int step)
        throws aos.jack.jak.beliefset.BeliefSetException
    {
        rmit.ai.clima.jackagt.data.CurrentRequestActionId.__complex_10 __c = new rmit.ai.clima.jackagt.data.CurrentRequestActionId.__complex_10(step);
        try {
            return __c.setCursor(__c.__complex_10_check_step());
        }
        catch (java.lang.Exception __e) {
    ...
    public int step()
        throws aos.jack.jak.beliefset.BeliefSetException
    {
        rmit.ai.clima.jackagt.data.CurrentRequestActionId.__complex_12 __c = new rmit.ai.clima.jackagt.data.CurrentRequestActionId.__complex_12();
        try {
            return __c.__complex_12_step();
        }
        catch (java.lang.Exception __e) {
    ...
    class __complex_7 extends aos.jack.plugin.view.rt.CleanupCursor {
        ...
        public __complex_7(aos.jack.jak.logic.IntegerVariable $id)
        {
            super($id);
            this.$id = $id;
        }
        
        aos.jack.jak.cursor.Cursor __complex_7_query_id()
            throws java.lang.Exception
        {
    ...
    class __complex_8 extends aos.jack.plugin.view.rt.CleanupCursor {
        ...
        public __complex_8(aos.jack.jak.logic.IntegerVariable $step)
        {
            super($step);
            this.$step = $step;
        }
        
        aos.jack.jak.cursor.Cursor __complex_8_query_step()
            throws java.lang.Exception
        {
            __local_2 = (aos.jack.jak.logic.IntegerVariable) new_variable(java.lang.Integer.TYPE);
            return genCursor(0);
    ...
    class __complex_9 extends aos.jack.plugin.view.rt.CleanupCursor {
        ...
        public __complex_9(int id)
        {
            super();
            this.id = id;
        }
        
        aos.jack.jak.cursor.Cursor __complex_9_check_id()
            throws java.lang.Exception
        {
            __local_2 = (aos.jack.jak.logic.IntegerVariable) new_variable(java.lang.Integer.TYPE);
            return genCursor(0);
    ...
    class __complex_10 extends aos.jack.plugin.view.rt.CleanupCursor {
        ...
        public __complex_10(int step)
        {
            super();
            this.step = step;
        }
        
        aos.jack.jak.cursor.Cursor __complex_10_check_step()
            throws java.lang.Exception
        {
            __local_2 = (aos.jack.jak.logic.IntegerVariable) new_variable(java.lang.Integer.TYPE);
            return genCursor(0);
