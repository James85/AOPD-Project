...
public class AgentGold__Tuple extends aos.jack.jak.beliefset.Tuple implements aos.apib.Base, java.io.Serializable {
...
public AgentGold__Tuple(boolean v)
{
    super();
    isFree = v;
}
...
public int hash(int __i)
{
  ...
  public AgentGold__Tuple() {
    streamer.setup();
    if (!getStreamer().initialized) return;
    __init__AgentGold__Tuple();
  }

  /** Automatically generated method. */
  void __init__AgentGold__Tuple() {
	agentName = null;
	goldAmount = 0;
  ...
  static class __SS extends aos.apib.StreamerSupport {
    ...
    protected void setup() {
      ...
      __def = (AgentGold__Tuple)newInstance();
    ...
    protected void init() {
      setup();
      __def.__init__AgentGold__Tuple();
    }
    ...
    public aos.apib.Base new_instance() {
      return new AgentGold__Tuple();
    }

    /** JACOB method. */
    public aos.apib.Base[] new_array(int n) {
      return new AgentGold__Tuple[n];
    }
    ...
    public boolean readField(aos.apib.InStream in, aos.apib.Base o,int i) {
      ...
      AgentGold__Tuple v = (AgentGold__Tuple)o;
      switch (i) {
      case 0:
   ...
   case 1:
	...
	break;
      ...
      default:
        if (i >= 0 && i <= 2) break;
        in.error("Reader for AgentGold__Tuple: illegal field number:"+i);
        return false;
      }
      return true;
    }
   ...
   case 1:
	...
	break;
        ...
        default:
          if (i >= 0 && i <= 2) break;
          out.error("Writer for AgentGold__Tuple: illegal field number:"+i);
          return false;
        }
      }
      return true;
