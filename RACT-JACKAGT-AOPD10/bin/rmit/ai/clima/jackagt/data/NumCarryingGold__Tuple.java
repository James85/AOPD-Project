...
public class NumCarryingGold__Tuple extends aos.jack.jak.beliefset.Tuple implements aos.apib.Base, java.io.Serializable {
...
public NumCarryingGold__Tuple(boolean v)
{
    super();
    isFree = v;
}
...
public int hash(int __i)
{
    ...
    switch (__i) {
        case 0: 
        {
            __r ^= (((int) (goldCount ^ (goldCount << 13))) & (~(1 << 31)));
            return __r;
        }
        case 1: 
        {
  ...
  public NumCarryingGold__Tuple() {
    streamer.setup();
    if (!getStreamer().initialized) return;
    __init__NumCarryingGold__Tuple();
  }

  /** Automatically generated method. */
  void __init__NumCarryingGold__Tuple() {
	goldCount = 0;
  ...
  static class __SS extends aos.apib.StreamerSupport {
    NumCarryingGold__Tuple __def = null;
    ...
    protected void setup() {
      ...
      __def = (NumCarryingGold__Tuple)newInstance();
    ...
    protected void init() {
      setup();
      __def.__init__NumCarryingGold__Tuple();
    }
    ...
    public aos.apib.Base new_instance() {
      return new NumCarryingGold__Tuple();
    }

    /** JACOB method. */
    public aos.apib.Base[] new_array(int n) {
      return new NumCarryingGold__Tuple[n];
    }
    ...
    public boolean readField(aos.apib.InStream in, aos.apib.Base o,int i) {
      ...
      NumCarryingGold__Tuple v = (NumCarryingGold__Tuple)o;
      switch (i) {
      case 0:
	v.goldCount = in.getInt();
	break;
      case 1:
      ...
      default:
        if (i >= 0 && i <= 1) break;
        in.error("Reader for NumCarryingGold__Tuple: illegal field number:"+i);
        return false;
      }
      return true;
    }
    ...
    public boolean write(aos.apib.OutStream out, aos.apib.Base o) {
      ...
      while ((i = out.nextField(i, this)) >= 0) {
        switch (i) {
      case 0:
	out.putInt(v.goldCount, i, __def.goldCount, this);
	break;
        case 1:
        ...
        default:
          if (i >= 0 && i <= 1) break;
          out.error("Writer for NumCarryingGold__Tuple: illegal field number:"+i);
          return false;
        }
      }
      return true;
	...
	if (v.goldCount != __def.goldCount) return false;
