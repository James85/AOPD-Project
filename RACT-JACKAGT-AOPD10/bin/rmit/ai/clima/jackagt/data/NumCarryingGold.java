...
public class NumCarryingGold extends aos.jack.jak.beliefset.ClosedWorld {
    ...
    public aos.jack.jak.beliefset.BeliefSetCursor getCarryingGold(aos.jack.jak.logic.IntegerVariable __v0)
        throws aos.jack.jak.beliefset.BeliefSetException
    {
        ...
        if (!__v0.check_unifiable(java.lang.Integer.TYPE)) 
            throw new aos.jack.jak.beliefset.BeliefSetException("NumCarryingGold:getCarryingGold:O: arg 0 goldCount Incorrect Variable type");
        if (__v0.isGround()) {
            try {
                __t.goldCount = __v0.as_int();
            }
            catch (java.lang.Exception e) {
                throw new aos.jack.jak.beliefset.BeliefSetException("NumCarryingGold:getCarryingGold:O: got " + e.toString());
            }
        }
         else 
            __c.goldCount = __v0;
